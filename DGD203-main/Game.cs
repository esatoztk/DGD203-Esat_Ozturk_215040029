...
namespace DGD203_2
{
    public class Game
    {
        ...
        {
            Console.WriteLine("Welcome to the Middle Earth Fellow Friend");
            Console.WriteLine("A good burglar hides a mystrious name what is yours ?");
            _playerName = Console.ReadLine();

            if (_playerName == "Ulbar")
            {
                Console.WriteLine($"Here comes {_playerName}!!");
            }
            else if (_playerName == "Ciryatan")
            {
                Console.WriteLine("Player name not entered, giving the name Ciryatan");
                _playerName = "Ciryatan";
            }
            else
            {
                Console.WriteLine($"Pleased to meet you {_playerName}, we will face great dangers");
            }
        }
        ...
        private void ProcessInput()
        {
            ...
            switch (_playerInput)
            {
                ...
                case "clear":
                    ...
                    break;
                case "who":
                    Console.WriteLine($"You are {Player.Name}, mariner and companion of Aldarion from Emerië. Father of Îbal.");
                    break;
                case "take":
        ...
        {
            Console.WriteLine("Well, here at last, dear friend, on the shores of the Sea comes the end of our fellowship in Middle-earth. Go in peace! I will not say: do not weep; for not all tears are an evil.");
            _gameRunning = false;
        }
